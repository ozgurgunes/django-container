...
from apps.registration.admin import RegistrationAdmin
from apps.registration.backends import get_backend
from apps.registration.backends.default import DefaultBackend
...
class BackendRetrievalTests(TestCase):
    ...
    def test_get_backend(self):
        ...
        """
        self.failUnless(isinstance(get_backend('apps.registration.backends.default.DefaultBackend'),
                                   DefaultBackend))
    ...
    def test_backend_error_invalid(self):
        ...
        self.assertRaises(ImproperlyConfigured, get_backend,
                          'apps.registration.backends.doesnotexist.NonExistentBackend')
    ...
    def test_backend_attribute_error(self):
        ...
        """
        self.assertRaises(ImproperlyConfigured, get_backend,
                          'apps.registration.backends.default.NonexistentBackend')
...
class DefaultRegistrationBackendTests(TestCase):
    ...
    def test_form_class(self):
        ...
        ``apps.registration.forms.RegistrationForm``.
