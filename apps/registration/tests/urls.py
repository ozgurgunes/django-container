...
urlpatterns = patterns('',
                       ...
                       url(r'^activate-with-template-name/(?P<activation_key>\w+)/$',
                           ...
                           {'template_name': 'registration/test_template_name.html',
                            'backend': 'apps.registration.backends.default.DefaultBackend'},
                       ...
                       # on successful apps.registration.
                       ...
                       (r'', include('apps.registration.backends.default.urls')),
                       )
