...
from core.profiles import utils, forms
...
@login_required
def user_edit(request, context={}, form=forms.NameForm, template_name='profiles/profile_form.html'):
    """Edit profile."""
    user = get_object_or_404(User, username=request.user.username)
    context['object'] = user.get_profile()
    if request.POST:
        ...
        context['form'] = form(instance=user)
    return render_to_response(template_name, context, context_instance=RequestContext(request))
