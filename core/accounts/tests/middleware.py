...
from core.accounts.tests.profiles.test import ProfileTestCase
from core.accounts.tests.profiles.models import Profile
from core.accounts.middleware import AccountsLocaleMiddleware
from core.accounts import settings as accounts_settings

class AccountsLocaleMiddlewareTests(ProfileTestCase):
    """ Test the ``AccountsLocaleMiddleware`` """
    ...
    def test_preference_user(self):
        ...
        for pk, lang in users:
            ...
            AccountsLocaleMiddleware().process_request(req)
